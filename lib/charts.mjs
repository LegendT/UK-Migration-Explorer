...
const GEOM = {
  ...
  // yInside was tried and withdrawn. Putting the value labels inside the plot bought about 90
  // units of width and cost the thing the chart is for: the series ran through the labels, and
  // the opaque box needed to knock it out then hid the 2012 to 2014 data behind "200,000".
  // A measured gutter leaves 250 units of plot for fourteen years, which is ample, and no
  // label and no data point can collide by construction.
  narrow: { key: 'narrow', W: 360, H: 300, pad: { top: 64, right: 10, bottom: 40, left: 2 }, yInside: false, legend: true, xTarget: 4, barRow: 66, barGutter: 0, edgeAnchor: true },
};
