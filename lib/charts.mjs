...
// points as well is the inversion The order's item 27 describes, and it has to decide what one
// line says when a chart's points disagree, so it is not done here.
