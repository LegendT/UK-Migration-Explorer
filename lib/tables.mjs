...
// five letters, an underscore, one to four alphanumerics. Checked against every string in data/,
// where it matches the twelve real tables and nothing else. Widening it to six either side also
// matches metric_name, period_label, source_name and source_url written as prose, and drops T_3.
