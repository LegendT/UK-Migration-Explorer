// A fetch that waits when a host says "later". Imported by check-releases.mjs alone:
// check-sources.mjs has its own, with browser headers and a curl route, for a different refusal.
//
