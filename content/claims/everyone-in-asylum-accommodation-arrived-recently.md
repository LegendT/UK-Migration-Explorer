...
It reads a snapshot as though it were an annual intake. The number of people supported on
one day is not the number of people who arrived that year, and the two are not
interchangeable.
...
This site does not currently hold a figure for how long people typically remain in asylum
accommodation, so it will not assert one. What the published statistics support is the
narrower point that the supported population includes people at very different stages,
some of whom have been waiting a long time. Precisely how long, and for how many, is a
question the available figures do not answer.
