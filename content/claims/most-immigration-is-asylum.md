...
short_answer: >-
  No. Asylum accounted for around 14% of non-EU+ arrivals in the year ending December
  2025. Study and work were both larger.
...
There is a second, quieter problem with the claim, which is that it invites you to
compare figures that are not comparable. Three different numbers get used
...
different things. Setting one against another and reading the difference as a finding is
not analysis.
